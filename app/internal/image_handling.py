...
def process_image(
    ...
    try:
        ...
        data_manager.updateRecord(
            record_id, record, update_type="record", forceUpdate=True, calling_function="process_image",
        )
        return
    ...
    data_manager.updateRecord(record_id, record, update_type="record", forceUpdate=True, calling_function="process_image",)
